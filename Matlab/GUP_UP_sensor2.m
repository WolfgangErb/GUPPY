...
filtpar.idxcen = 50;          %Index of center node (spatial filter)
filtpar.fcen = G.nodes(50,:); %Center node (spatial filter)
filtpar.frad = 0.25;          %Radius (spatial filter)
filtpar.gK = 100;             %Range of spectrum (spectral filter)
...
% print('C:\Uni\Publikationen\2019\graphuncertainty\software\images\ShapeUP_sensor2','-dpng','-r1800','-painters');
...
[f,g] = GUP_genfilter(G,'slepian',filtpar);
plotpar.title = 'P-P filter zoom';
GUP_drawshape(G,f,g,plotpar);
axis([0.99 1.004 0.99 1.004]);

%print('C:\Uni\Publikationen\2019\graphuncertainty\software\images\ShapeUP_sensor2_zoom','-dpng','-r1200','-painters');
