...
filtpar.idxcen = 30;          %Index of center node (spatial filter)
filtpar.fcen = G.nodes(30,:); %Center node (spatial filter)
filtpar.frad = 0.2;           %Radius (spatial filter)
